...
cd "$repo_dir"
docker compose ps application-postgres temporal temporal-ui portal-api agent-worker portal bifrost agentgateway-spike diagnostic-mcp demo-time-mcp demo-mtg-catalog-mcp langfuse-web langfuse-worker
