...
grep -q 'AGENT_RUNNER_URL: http://${TARGET_RUNNER_HOST:-host.containers.internal}:' "$overlay"
grep -q 'MCP_GATEWAY_URL: http://${TARGET_HOST_BRIDGE:-10.255.0.1}:8089' "$overlay"
