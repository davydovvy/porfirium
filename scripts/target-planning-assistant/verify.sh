...
agent_dir="$repo_dir/agents/planning-assistant/1.0.0"
image="porfirium-planning-assistant-verification:$$"
...
docker run --rm \
  ...
  --workdir /repo/agents/planning-assistant/1.0.0 "$uv_image" \
...
echo "PASS: planning-assistant release behavior, manifest, publication, and OCI image"
