...
> Transition update (2026-08-22): accepted architecture transition Increments 3–5 moved MCP and model execution to Agentgateway and retired Bifrost without changing the Phase 4 behavior recorded here.
